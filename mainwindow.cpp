...
{
    QSettings settings("Settings","EFM-DC");
...
{
    QSettings settings("varshneydevansh","EFM-DC_V2");

    QString name;

    if(QObject::sender() == ui->actionBlack)
    {
        settings.setValue("EFM-DC_V2-theme","black");
        name = tr("Black");
    }
    else if(QObject::sender() == ui->actionBlue)
    {
        settings.setValue("EFM-DC_V2-theme","blue");
        name = tr("Blue");
    }
    else if(QObject::sender() == ui->actionGreen)
    {
        settings.setValue("EFM-DC_V2-theme","green");
        name = tr("Green");
    }
    else if(QObject::sender() == ui->actionPink)
    {
        settings.setValue("EFM-DC_V2-theme","pink");
        name = tr("Pink");
    }
    else if(QObject::sender() == ui->actionRed)
    {
        settings.setValue("EFM-DC_V2-theme","red");
        name = tr("Red");
    }
...
void MainWindow::getHelp()
{
    ...
    if(QObject::sender() == ui->actionAbout)
    {
        ...
        content->append(tr("EFM-DC designed for LAN chat"));
        content->append(tr("\nFunction:"));
        ...
        content->append(tr("<a href=\"https://github.com/varshneydevansh/EFM-DC_V2\"> %1 </a>").arg(tr("click to know more.")));
        content->append(tr("\nThe program is Free to use."));
        content->append(tr("Copyright 2017 Devansh Varshney"));
    ...
    else if(QObject::sender() == ui->actionHelp)
    {
        ...
        content->append(tr("EFM-DC_V2 Help"));
        content->append(tr("\n --- Nick Name Help"));
